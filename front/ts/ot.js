...
export var TypeOperator;
(function (TypeOperator) {
    TypeOperator[TypeOperator["Retain"] = 1] = "Retain";
    TypeOperator[TypeOperator["Insert"] = 2] = "Insert";
    TypeOperator[TypeOperator["Delete"] = 3] = "Delete";
...
export function insertLength(atom) {
...
export class Operator {
    ...
    transform(other) {
        ...
        for (;;) {
            ...
            throw new Error("unsupported operator pair: the two operators are not compatible " +
    ...
    static parse(json) {
        return Operator.fromJSON(JSON.parse(json));
    }
}
/**
